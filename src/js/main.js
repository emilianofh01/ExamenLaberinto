...
function init() {
  ...
  ctx.drawImage(calca, 0, 0, canvas.width, canvas.height);
  ...
  printWalls({times: 8, x: 84, y: 25, spaceBetweenX: 16, image: objects["paredHorizontal"]});
  ...
  printWalls({times: 1, x: 260, y: 305, spaceBetweenX: 10, image: objects["paredIzqrArribaAbajo"]});
